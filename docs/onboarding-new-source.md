...
> เอกสารที่เกี่ยวข้อง — [`dump-checklist.md`](dump-checklist.md) คือเช็คลิสต์สั้น ๆ ที่ไล่ทีละข้อตั้งแต่เปิดดัมป์จนกดรัน ใช้คู่กับเอกสารนี้ · [`llm2viz-flow.md`](llm2viz-flow.md) คือแผนที่ภาพเดียวของทั้งเส้นทาง ตั้งแต่ฐานข้อมูลอื่นจนถึงกราฟบนจอ อ่านก่อนถ้ายังไม่เห็นภาพรวม · `docs/iotvision-report/index.html` ข้อ 2.6 (ต่อ 3) ถึง (ต่อ 10) อธิบายเหตุผลเบื้องหลังดีไซน์นี้ · `scripts/nj5-registry.sql` คือทะเบียนจริงที่ใช้งานอยู่ ใช้เป็นตัวอย่างอ้างอิงได้เสมอ
